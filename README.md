...
4. Anexe/salve o arquivo **Continentes e sub_regiões.csv** ao Colab ou jupyter nootebook. Anexe/salve o arquivo **database.sxlsx** ao Google Drive e atualize o código abaixo que está no passo **'1. Importar as bibliotecas necessárias e ler dataframe'** com o link do seu arquivo no seu Goole Drive:
